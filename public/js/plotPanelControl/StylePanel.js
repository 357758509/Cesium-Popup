 ...
 */
    ...
    var StylePanel = function(div,plotEditControl,plotting) {
        ...
        this._displayTextContentName = ["注记内容", "注记位置", "字体背景颜色", "注记大小", "注记字体", "注记颜色", "字体边框", "边框宽度", "边框颜色", "总是显示中间注记"];
    ...
    StylePanel.prototype.collectionPropertyGridRows = function(graphicObject) {
        ...
        if (null !== graphicObject && undefined !== graphicObject) {
            ...
            //贴地形
            var isClampToGround = new Object();
            isClampToGround.name = this._algoGroup[0];
            isClampToGround.value = this.checkboxValueToString(this._selectedFeature.isClampToGround);
            isClampToGround.group = this._group[0];
            isClampToGround.editor = {"type": 'checkbox', "options": {"on": true, "off": false}};
            ...
            //总是显示中间注记
            var alwaysHasMiddelText = new Object();
            alwaysHasMiddelText.name = this._displayTextContentName[9];
            alwaysHasMiddelText.value = this.checkboxValueToString(this._selectedFeature.alwaysHasMiddelText);
            alwaysHasMiddelText.group = this._group[5];
            alwaysHasMiddelText.editor = {"type": 'checkbox', "options": {"on": true, "off": false}};
